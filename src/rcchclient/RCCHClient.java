 ...
 * @author Hassan Khan
 */
public class RCCHClient extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        //scene.getStylesheets().
          //      add(UI.class.getResource("Login.css").toExternalForm());
    ...
    //TODO replace with CALVINs design
    public String enterName(){ //was originally private 
